...
<div class="wp-block-column" style="flex-basis:66.66%"><!-- wp:image {"id":194,"width":375,"height":375,"sizeSlug":"large","className":"is-style-rounded"} -->
<figure class="wp-block-image size-large is-resized is-style-rounded"><img src="https://cbdarvada.com/wp-content/uploads/2020/07/Arvada.SHaman-1.jpg" alt="" class="wp-image-194" width="375" height="375"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->

<!-- wp:column {"width":33.33} -->
<div class="wp-block-column" style="flex-basis:33.33%"><!-- wp:image {"id":258,"sizeSlug":"large","className":"is-style-rounded"} -->
