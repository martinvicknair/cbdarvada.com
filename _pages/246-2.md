...
<div class="wp-block-column" style="flex-basis:66.66%"><!-- wp:image {"align":"wide","id":258,"sizeSlug":"large","className":"is-style-rounded"} -->
<figure class="wp-block-image alignwide size-large is-style-rounded"><img src="https://cbdarvada.com/wp-content/uploads/2020/08/open-business.jpg" alt="" class="wp-image-258"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->
