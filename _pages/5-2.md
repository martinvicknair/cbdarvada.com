...
<p class="has-text-align-center">Arvada West<br>12pm - 6pm<br>Monday - Saturday</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->

<!-- wp:column -->
<div class="wp-block-column"><!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center">Arvada Wadsworth<br> 10am - 4pm<br> Monday - Saturday</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
